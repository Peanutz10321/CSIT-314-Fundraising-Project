...
class viewSingleCompletedActivityController:

    def viewCompletedActivity(self, fundraiserID: int, activityID: int):
        return FundraisingActivity.viewCompletedActivity(fundraiserID, activityID)
