...
import { generateMonthlyReport } from "../../../api/reportsApi";
...
function PieChart({ data }) {
  ...
  const slices = data.reduce((acc, d, i) => {
    ...
    return {
      startAngle: endAngle,
      slices: [...acc.slices, { path: `M${cx},${cy} L${x1},${y1} A${r},${r} 0 ${largeArc},1 ${x2},${y2} Z`, color: CHART_COLORS[i % CHART_COLORS.length] }],
    };
